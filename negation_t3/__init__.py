...
class Player(BasePlayer):
    ...
    #                               widget=widgets.RadioSelect)
    Q_sender_strategy = models.LongStringField(label="<h4>5. Please explain your reasoning in composing messages.</h4>",
                                               blank=True)
    Q_receiver_strategy = models.LongStringField(
        label="<h4>5. Please explain how you interpreted the messages received.</h4>", blank=True)
